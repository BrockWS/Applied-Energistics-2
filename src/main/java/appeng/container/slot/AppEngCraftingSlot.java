...
public class AppEngCraftingSlot extends AppEngSlot
{
	...
	public AppEngCraftingSlot( final PlayerEntity par1EntityPlayer, final IItemHandler par2IInventory, final IItemHandler par3IInventory, final int par4, final int par5, final int par6 )
	{
