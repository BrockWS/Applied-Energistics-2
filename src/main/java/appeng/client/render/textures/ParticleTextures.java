...
public class ParticleTextures
{
	...
	{
//		BlockEnergyParticle = event.addSprite( new ResourceLocation( "appliedenergistics2:particles/energy" ) );
//		BlockMatterCannonParticle = event.addSprite( new ResourceLocation( "appliedenergistics2:particles/matter_cannon" ) );
	}
}
