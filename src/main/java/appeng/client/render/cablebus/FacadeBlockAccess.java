 ...
 * @author covers1624
 */
public class FacadeBlockAccess implements IEnviromentBlockReader
{
	...
	public FacadeBlockAccess( IEnviromentBlockReader world, BlockPos pos, Direction side, BlockState state )
	{
		this.world = world;
		this.pos = pos;
		this.side = side;
