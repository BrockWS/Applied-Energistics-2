...
public abstract class AEBaseTileBlock extends AEBaseBlock
{

	@Nonnull
	private TileEntityType<? extends AEBaseTile> tileEntityType;
	...
	public AEBaseTileBlock( final Properties properties )
	{
		super( properties );
	}
...
//	@Nullable
//	public <T extends AEBaseTile> T getTileEntity( final IEnviromentBlockReader w, final int x, final int y, final int z )
//	{
//		return this.getTileEntity( w, new BlockPos( x, y, z ) );
//	}
//
//	@Nullable
//	public <T extends AEBaseTile> T getTileEntity( final IEnviromentBlockReader w, final BlockPos pos )
//	{
...
//
//	@Override
//	public void onBlockPlacedBy( final World w, final BlockPos pos, final BlockState state, final EntityLivingBase placer, final ItemStack is )
//	{
