...
public abstract class AEBaseBlock extends Block
{
	...
	protected AEBaseBlock( final Material mat )
	{
		super( Properties.create(mat)
				.sound(getSoundType(mat))
				.harvestTool(ToolType.PICKAXE)
				.harvestLevel(0)
				.hardnessAndResistance(2.2f, 11f)
				.lightValue(0)
		);
	}

	protected AEBaseBlock( final Properties properties )
	{
		super( properties );
	}
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		if (this.getDefaultState().has(BlockStateProperties.AXIS))
			...
			switch(rot) {
				...
				case CLOCKWISE_90:
					switch(state.get(BlockStateProperties.AXIS)) {
						case X:
							return state.with(BlockStateProperties.AXIS, Direction.Axis.Z);
						case Z:
							return state.with(BlockStateProperties.AXIS, Direction.Axis.X);
						default:
							return state;
					}
				default:
	...
	//    @Override
//	public final boolean isNormalCube( BlockState state, IBlockReader worldIn, BlockPos pos )
//	{
...
//	@SuppressWarnings( "deprecation" )
//	@Override
//	public VoxelShape getRenderShape( BlockState state, final IBlockReader w, final BlockPos pos )
//	{
//		final ICustomCollision collisionHandler = this.getCustomCollision( w, pos );
//
...
//
//	@Override
//	public final boolean isNormalCube( BlockState state, final IEnviromentBlockReader world, final BlockPos pos )
//	{
...
//	@OnlyIn( Dist.CLIENT )
//	@Override
//	public void addInformation(final ItemStack is, final IBlockReader world, final List<ITextComponent> lines, final ITooltipFlag advancedItemTooltips )
//	{
//
//	}
//
...
//	}
//
//	protected IOrientable getOrientable( final IEnviromentBlockReader w, final BlockPos pos )
//	{
...
//	}
	...
	private static SoundType getSoundType(Material mat) {
