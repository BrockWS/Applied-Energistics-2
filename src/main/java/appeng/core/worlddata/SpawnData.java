...
final class SpawnData implements IWorldSpawnData
{
	...
	@Override
	public boolean addNearByMeteorites( final int dim, final int chunkX, final int chunkZ, final CompoundNBT newData )
	{
		synchronized( SpawnData.class )
		{
			final CompoundNBT data = this.loadSpawnData( dim, chunkX, chunkZ );
	...
	@Override
	public Collection<CompoundNBT> getNearByMeteorites( final int dim, final int chunkX, final int chunkZ )
	{
