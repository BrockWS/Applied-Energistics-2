...
//				.useCustomItemModel()
				.rendering( new BlockRenderingCustomizer()
				{
					...
					{
						rendering.builtInModel( "builtin/quartz_glass", new GlassModel() );
					}
				} )
				.build();
...
//				.build();
		...
		this.skyStoneSlab = registry
				.block("sky_stone_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.smoothSkyStoneSlab = registry
				.block("smooth_sky_stone_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.skyStoneBrickSlab = registry
				.block("sky_stone_brick_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.skyStoneSmallBrickSlab = registry
				.block("sky_stone_small_brick_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.fluixSlab = registry
				.block("fluix_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.quartzSlab = registry
				.block("quartz_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.chiseledQuartzSlab = registry
				.block("chiseled_quartz_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
		this.quartzPillarSlab = registry
				.block("quartz_pillar_slab", () -> new SlabBlock(Block.Properties.create(Material.ROCK)))
				.addFeatures(AEFeature.DECORATIVE_BLOCKS)
				.build();
...
//				.build();
	...
	{
		return registry.block( registryName, () -> new BlockStairCommon( block.maybeBlock().get(), null ) )
