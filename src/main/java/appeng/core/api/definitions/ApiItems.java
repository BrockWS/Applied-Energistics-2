...
public final class ApiItems implements IItems
{
	...
	private IColoredItemDefinition coloredPaintBall;
	private IColoredItemDefinition coloredLumenPaintBall;
...
//
		...
		this.cell1k = storageCells.item( "storage_cell_1k", () -> new BasicItemStorageCell( 0, 1 ) ).build();
		this.cell4k = storageCells.item( "storage_cell_4k", () -> new BasicItemStorageCell( 1, 4 ) ).build();
		this.cell16k = storageCells.item( "storage_cell_16k", () -> new BasicItemStorageCell( 2, 16 ) ).build();
		this.cell64k = storageCells.item( "storage_cell_64k", () -> new BasicItemStorageCell( 3, 64 ) ).build();
//
...
//				.build();
		this.coloredPaintBall = registry.colored("%s_paint_ball", AEColor.VALID_COLORS, color -> new ItemPaintBall(color, false))
				.rendering(new ItemPaintBallRendering())
				.build();
		this.coloredLumenPaintBall = registry.colored("%s_lumen_paint_ball", AEColor.VALID_COLORS, color -> new ItemPaintBall(color, true))
				.rendering(new ItemPaintBallRendering())
				.build();
//
...
//		this.dummyFluidItem = registry.item( "dummy_fluid_item", FluidDummyItem::new ).rendering( new FluidDummyItemRendering() ).build();
	...
	@Override
	public IColoredItemDefinition coloredPaintBall()
	{
		return this.coloredPaintBall;
	}

	@Override
	public IColoredItemDefinition coloredLumenPaintBall()
	{
